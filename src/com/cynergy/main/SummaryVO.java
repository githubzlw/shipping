...
public class SummaryVO {
	...
	public String getPurnoall() {
		return purnoall;
	}

	public void setPurnoall(String purnoall) {
		this.purnoall = purnoall;
	}
	...
	public String getTimesall() {
		return timesall;
	}

	public void setTimesall(String timesall) {
