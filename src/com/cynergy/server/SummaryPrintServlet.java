...
public class SummaryPrintServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			List<SummaryVO> summaryVOList = summaryServlet.getSummaryList(year,month);

			//生成的excel路径
			String excelPath = ProjectStatisticsPrint.printExcelSummary(request, summaryVOList);
