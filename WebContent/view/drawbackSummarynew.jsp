  	...
  	<h1 align="center">退税汇总</h1>
  	 <form action="NewDrawBackSummaryServlet" id="form1">
  	   ...
  	   <c:if test="${year==2020 }"><option  value ="2020">2020年</option></c:if>
		   <c:if test="${year==2021 }"><option  value ="2021">2021年</option></c:if>
		   <c:if test="${year==2022 }"><option  value ="2022">2022年</option></c:if>
		   <c:if test="${year==2023 }"><option  value ="2023">2023年</option></c:if>
